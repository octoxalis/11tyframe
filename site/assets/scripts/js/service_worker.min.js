...
=======
const ID_s      = 'wic'
>>>>>>> 70c9c5e6518bb7f7165611ea0ec3d89187965c9c
...
<<<<<<< HEAD
  ...
  'http://127.0.0.1:5500/offline.html',
  'http://127.0.0.1:5500/assets/scripts/js/service_worker.min.js',
  'http://127.0.0.1:5500/assets/scripts/js/lib.min.js',
  'http://127.0.0.1:5500/assets/styles/css/lib.min.css',
...
=======
  ...
  'http://127.0.0.1:8080/assets/scripts/js/service_worker.min.js',
  'http://127.0.0.1:8080/assets/scripts/js/lib.min.js',
  'http://127.0.0.1:8080/assets/styles/css/lib.min.css',
...
<<<<<<< HEAD
          .then( cache_o => cache_o.match( new Request( `http://127.0.0.1:5500/offline.html` ) ) )
=======
          .then( cache_o => cache_o.match( new Request( `http://127.0.0.1:8080/offline.html` ) ) )
>>>>>>> 70c9c5e6518bb7f7165611ea0ec3d89187965c9c
    } )
}
