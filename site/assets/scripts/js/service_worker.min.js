...
[
  'https://11tyframe.netlify.com/',
  'https://11tyframe.netlify.com/index.html',
  'https://11tyframe.netlify.com/menu.html',
  `https://11tyframe.netlify.com/offline.html`,
  'https://11tyframe.netlify.com/assets/scripts/js/service_worker.min.js',
  'https://11tyframe.netlify.com/assets/scripts/js/lib.min.js',
  'https://11tyframe.netlify.com/assets/styles/css/lib.min.css',
  'https://11tyframe.netlify.com/favicon.ico',
]
    ...
    .then( response_o =>
    {
      ...
      return response_o ||        //: We have a cached version, display it
        caches.open( CACHE_s )    //: We don't have a cached version, display offline page
          .then( cache_o =>
          {
            const request_o = new Request( `https://11tyframe.netlify.com/offline.html` )
