...
<<<<<<< HEAD
const idb_o = new KVIdb( '11tyframe_idb', '11tyframe_store', )
=======
...
const hueBase__v = hue_n =>    //: if page load, mode_n undefined (no parameter)
{
  idb_o.get__( 'hue_base' )
    ...
    {
<<<<<<< HEAD
      if ( hue_n === undefined ) hue_n = current_n || +'0'  //: at page load only
=======
...
<<<<<<< HEAD
  const key_s = location_s.slice( location_s.lastIndexOf( 'posts/'), -extension_n )
=======
...
<<<<<<< HEAD
    script_e.setAttribute( 'repo', 'octoxalis/11tyframe' )
=======
...
const linkNear__v = ( event_s, link_e ) =>
{
  ...
  if ( event_s === 'mouseenter' )
  {
    ...
    {
<<<<<<< HEAD
      title_s = `<a href="http://127.0.0.1:5500/${near_o.link_s}.html">${near_o.title_s}</a>`
=======
